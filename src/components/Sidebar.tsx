    ...
    <aside className="w-64 bg-[#0f172a] text-white flex flex-col flex-shrink-0">
      ...
      <div className="p-6 border-b border-slate-700">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold tracking-tight">EcoTrack</h1>
            <p className="text-xs text-slate-400">Waste Management ERP</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-slate-700">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">admin@ecotrack.com</p>
          </div>
        </div>
      </div>
    </aside>
